...
public class HtmlSubTest {
    public static void main(String[] args) {

        WebDriver driver = new HtmlUnitDriver();
        driver.get("http://my-tcc2:8080/webapp/sub.html");
        ...
        if (driver.getPageSource().contains(res)) {
          System.out.println("Pass: Difference of " + t1 + " & " + t2 + " is " + res);
        } else {
          System.out.println("Fail: Difference of " + t1 + " & " + t2 + " is not " + res);
        }
